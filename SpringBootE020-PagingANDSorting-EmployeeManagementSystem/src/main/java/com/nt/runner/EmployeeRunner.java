...
public class EmployeeRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        while (true) {
            ...
            System.out.println("12. View Employees with Pagination");
            System.out.println("13. View Employees Sorted by Salary");
            System.out.println("14. View Employees Sorted by Name");
            ...
            // Count Employees
            case 6-> System.out.println("Total Employees : " + service.getEmployeesCount());
           ...
           // 12. View Employees with Pagination
            case 12 ->
            {
            		int pageNo=Integer.parseInt(IO.readln("Enter the  page no : "));
            	    int data=Integer.parseInt(IO.readln("How many data you want : "));
	            	Page<Employee> page = service.getEmployeesByPage(pageNo,data);
            ...
            case 13 ->
            {
	            List<Employee>sal = service.getEmployeesSortedBySalary(true, "salary");
            ...
            case 14 ->
            {
	            List<Employee>ename = service.getEmployeesSortedByName(true, "employeeName");
